<template>
  <div class="seventh-page-container">
    <div class="content-wrapper" ref="contentWrapper">
      <img src="~/assets/images/object-1.png" alt="Object 1" class="object-1-small" ref="object1Small">
      <img src="~/assets/images/object-1.png" alt="Object 1" class="object-1-large" ref="object1Large">
      ...
      <div class="center-wrapper">
        ...
        <p class="description" ref="descriptionText" v-html="description">
...
const description = ref(`MIMIC이 가진 핵심 가치인 친철한 응대, 공정한 게임 운영, 청결한 환경, 초보자에 대한 배려 그리고 공동체의 성장을 바탕으로<br>
...
onMounted(() => {
  ...
  if (isMobile.value) {
    description.value = `MIMIC이 가진 핵심 가치인<br>
          친철한 응대, 공정한 게임 운영,<br>
...
@media (max-width: 768px) {
  .content-wrapper {
    width: 100vw;
    height: 100vh;
    /* Keep original position: relative; */
  }

  .object-1-small {
    width: 16.56vw;
    height: 16.56vw; /* Maintain aspect ratio */
    top: 3.15vh;
    left: 0vw;
    object-fit: contain;
  }
  ...
  .object-1-large {
    width: 26.04vw;
    height: 26.04vw; /* Maintain aspect ratio */
    bottom: -10.19vh;
    right: 1.56vw;
    object-fit: contain;
  }
